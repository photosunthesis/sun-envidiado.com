...
At work, though, almost nobody else is holding up theirs. Whatever comes out of the chat window gets forwarded to me unchecked, and I end up being the first person to actually look at it.
...
And that's basically is a prompt. I'm writing prompts. For a person. I'm aiming past them at whatever they're going to paste it into, low key prompt injecting my own coworkers so their LLM hands me something short and true and actually helpful.
